...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            ...
            bodyHtmlSnippet: "<div id='debuginfo' style='padding:5px;border:1px black solid;position:absolute;top:100px;left:100px;background-color:white;color:black;font-size:24px;'><label id='currentData'></label><input type='number' name='test' id='test' min='-99999.999' max='99999.999' step='0.001'/><label id='currentData2' ></label><input type='number' name='test2' id='test2' min='-99999.999' max='99999.999' step='0.001'/><label id='currentData3'></label><input type='number' name='test3' id='test3' min='-99999.999' max='99999.999' step='0.001'/></div><div id='threed'></div><div style='position: absolute;left:0;top:0;'><div id='debug'></div></div>",
